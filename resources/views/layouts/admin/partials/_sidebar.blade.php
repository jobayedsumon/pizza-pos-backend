            ...
            <div class="navbar-vertical-footer-offset">
                <div class="navbar-brand-wrapper justify-content-between">
                    ...
                    <button type="button" class="js-navbar-vertical-aside-toggle-invoker navbar-vertical-aside-toggle btn btn-icon btn-xs btn-ghost-dark">
                        <i class="tio-menu-hamburger navbar-vertical-aside-toggle-short-align" data-toggle="tooltip" data-placement="right" title="" data-original-title="Collapse"></i>
                        <i class="tio-clear navbar-vertical-aside-toggle-full-align" data-template="<div class=&quot;tooltip d-none d-sm-block&quot; role=&quot;tooltip&quot;><div class=&quot;arrow&quot;></div><div class=&quot;tooltip-inner&quot;></div></div>" data-toggle="tooltip" data-placement="right" title="" data-original-title="Expand"></i>
                    </button>
                    ...
                    <div class="navbar-nav-wrap-content-left d-none d-xl-block">
                        ...
                        <button type="button" class="js-navbar-vertical-aside-toggle-invoker close">
                            <i class="tio-menu-hamburger navbar-vertical-aside-toggle-short-align" data-toggle="tooltip" data-placement="right" title="" data-original-title="Collapse"></i>
                            <i class="tio-clear navbar-vertical-aside-toggle-full-align"></i>
                        </button>
                        <!-- End Navbar Vertical Toggle -->
                    </div>
                </div>
...
{{--                        @endif--}}
                        ...
                        @if(Helpers::module_permission_check(MANAGEMENT_SECTION['product_management']))
                            ...
                            <!-- Pages -->
                            <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/addon*') ||Request::is('admin/product*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:"
                                >
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/allergy*')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.allergy.add-new')}}"
                                           title="{{translate('add allergy')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span
                                                class="text-truncate">{{translate('Product_Allergy')}}</span>
                                        </a>
                                    </li>
...
{{--                        REPORT & ANALYTICS MANAGEMENT END--}}
                        ...
                        @if(Helpers::module_permission_check(MANAGEMENT_SECTION['user_management']))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/customer/transaction') || Request::is('admin/customer/list') || Request::is('admin/customer/view*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{Request::is('admin/customer/transaction') || Request::is('admin/customer/list')  || Request::is('admin/customer/view*')?'block':''}}; top: 831.076px;">
...
{{--                            </li>--}}
                    ...
                    <!-- @if(Helpers::module_permission_check(MANAGEMENT_SECTION['table_management']))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/table/list') || Request::is('admin/promotion/create') || Request::is('admin/table/index')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                    <i class="tio-gift nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                            {{translate('table')}}
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="top: 391.823px; display: {{Request::is('admin/table*') || Request::is('admin/promotion/*')?'block':''}};">
                                    ...
                                    <li class="nav-item {{Request::is('admin/promotion/create')?'active':''}}">
