...
@push('css_or_js')
    ...
    <link href="{{asset('public-assets/assets/back-end')}}/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
@endpush
...
@push('script')
    <!-- Page level plugins -->
    <script src="{{asset('public-assets/assets/back-end')}}/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="{{asset('public-assets/assets/back-end')}}/vendor/datatables/dataTables.bootstrap4.min.js"></script>
