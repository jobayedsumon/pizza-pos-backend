...
@push('css_or_js')
    ...
    <link rel="stylesheet" href="{{asset('public-assets/assets/admin/css/lightbox.css')}}">
@endpush
    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img width="20" class="avatar-img" src="{{asset('public-assets/assets/admin/img/icons/message.png')}}" alt="">
                    ...
                    <div class="py-4" id="conversation_sidebar">
                        <div class="chat_people media px-3 gap-3 mb-4">
                            <div class="avatar position-relative">
                                <img src="{{asset('/storage/app/public/admin/'.auth('admin')->user()->image)}}" class="img-fit rounded-circle" onerror="this.src='{{asset('public-assets/assets/admin')}}/img/160x160/img1.jpg'">
                ...
                <div class="d-flex justify-content-center align-items-center h-100">
                    <div class="align-items-center w-100" id="view-conversation">
                        <div class="d-flex h-100 w-100 justify-content-center align-items-center">
                            <div>
                                <img src="{{asset('public-assets/assets/admin/img/view-conv.png')}}" class="mw-100" alt="">
                            </div>
...
@endsection
@push('script_2')
    <script src="{{asset('public-assets/assets/admin/js/lightbox.js')}}"></script>
    {{-- Search --}}
    <script>
