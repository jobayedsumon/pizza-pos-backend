    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap justify-content-between gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img width="20" class="avatar-img" src="{{asset('public-assets/assets/admin/img/icons/bulk_import.png')}}" alt="">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-block">
                                <h4 class="display-2 text-dark mb-0">
                                    <span class="c1">{{count($product->rating)>0?number_format($product->rating[0]->average, 1, '.', ' '):0}}</span><span class="text-muted" style="font-size: 42px;">/5</span>
                                </h4>
                                    ...
                                    <div class="d-flex flex-column gap-1">
                                        @foreach(json_decode($product['variations'],true) as $variation)
                                            <div class="text-capitalize">
                                                <strong>{{$variation['type']}} :</strong> {{ \App\CentralLogics\Helpers::set_symbol($variation['price']) }}
                                            </div>
                                        @endforeach
                                    </div>
                                </td>
