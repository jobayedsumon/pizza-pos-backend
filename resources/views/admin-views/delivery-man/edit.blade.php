    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex flex-wrap gap-2 align-items-center mb-4">
            <h2 class="h1 mb-0 d-flex align-items-center gap-2">
                <img width="20" class="avatar-img" src="{{asset('public-assets/assets/admin/img/icons/deliveryman.png')}}" alt="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="password" class="form-control" placeholder="Ex: 8+ Character">
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <label class="input-label">{{translate('confirm_Password')}}</label>
                                        <input type="text" name="confirm_password" class="form-control" placeholder="Ex: 8+ Character">
                                    </div>
                                </div>
                            </div>
                        </div>
