...
Route::group(['namespace' => 'Branch', 'as' => 'branch.'], function () {
    ...
    Route::group(['middleware' => ['branch', 'branch_status']], function () {
        ...
        Route::group(['prefix' => 'pos', 'as' => 'pos.'], function () {
            ...
            Route::get('reorder/{order_id}', 'POSController@reorder')->name('reorder');
            ...
            Route::post('accept-order', 'POSController@accept_order')->name('accept-order');
            Route::post('accept-all-orders', 'POSController@accept_all_orders')->name('accept-all-orders');
            Route::get('order-details/{id}', 'POSController@order_details')->name('order-details');
            Route::get('invoice/{id}', 'POSController@generate_invoice');
            Route::post('invoice/multi', 'POSController@generate_multi_invoice')->name('multi-invoice');
        ...
        Route::group(['prefix' => 'orders', 'as' => 'orders.'], function () {
            ...
            Route::post('add-delivery-man-modal', 'OrderController@add_delivery_man_modal')->name('add-delivery-man-modal');
            ...
            Route::get('export-excel-pos', 'OrderController@export_excel_pos')->name('export-excel-pos');
            Route::get('export-excel-orders/{status}', 'OrderController@export_excel_orders')->name('export-excel-orders');
