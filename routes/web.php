...
Route::get('test-push', function () {
    $token = 'fla_SHbR7EUmnYzDxiP4mN:APA91bEGC28dfmpwC2LnA61yVRApk5UnFS5Pck4GCWHHyR2-LRt2cqcGgw5a9xwhjA2QeW1YNCocul7mqxOyIyeTfa2vKUxGpceOHiOM50SuCycRz_2o0gEfIsz2bOiP0f9iF7BLbasp';
    $data = [
        'title' => 'Order',
   ...
   $result = \App\CentralLogics\Helpers::send_push_notif_to_device($token, $data);
